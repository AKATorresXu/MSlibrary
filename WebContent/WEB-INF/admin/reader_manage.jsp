...
<body>
 ...
 %></a>
	...
	<div class="container">
		...
		<div class="row flat">
			<form action="<%=basePath%>AdminServlet" method="POST" id="form1">
			
				<div class="col-lg-333 col-md-333 col-xs-6">
				<input type="hidden" name="path" value="recharge"/>
					<ul class="plan plan1">
					
						<li class="plan-name">余额充值</li>
						<li class="plan-price"><strong>用户名:</strong> 
						<input type="text" required="required"  name="readerName" style="margin-left: 10px;color:black;" id="readerName"/>
						<span style="color: red;" >*输入充值用户名</span></li>
						<li><strong>选择金额:</strong><select name="money" style="margin-left: 10px;color:black;">
														<option value="10">￥：10元</option>
														<option value="30">￥：30元</option>
														<option value="50">￥：50元</option>
														<option value="100">￥：100元</option>
													</select><span style="color: red;" >*选择充值金额</span></li>
						<li class="plan-action"><input type="button" value="确认充值" class="btn btn-danger btn-lg"  onclick="add()"/></li>
					</ul>
				</div>
           </form>
		</div>
