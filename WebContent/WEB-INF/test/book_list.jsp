						...
						<tbody>
							<tr>
								<td height="20"  valign="middle"
									class="word_orange"><div style="font: left;display:inline;">当前位置：首页 &gt;&gt;&gt;&nbsp;书籍查询&gt;&gt;&gt;&nbsp;</div><div style="float: right;;display:inline;" >${message }</div></td>
							</tr>
							<tr>
											...
											<tr <c:if test="${status.count%2==0 }">bgcolor="gainsboro"</c:if>>
												...
												<td>
													<form action="<%=basePath %>BookServlet" method="POST" style="display:inline;" >
														...
														<input type="hidden" name="cate" value="${data[1] }">
