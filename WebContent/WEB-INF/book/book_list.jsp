				...
				<div class="col-lg-3 col-md-3 col-xs-6">
					<ul class="plan plan1">
						...
						<form method="post" action="<%=basePath%>OrderServlet?path=borrow">
													<input type="hidden" value="${data[0].id }" name="bookId">
													<div style="text-align: center;">
													<input id = "sub" type="submit" value="借阅《${data[0].bookname }》" class="btn btn-danger btn-lg"
													<c:if test="${data[0].restcount==0}">disabled="disabled" title="库存数量不足无法借阅" style="background-color: silver;"</c:if>
