						...
						<tbody>
							<tr>
								<td height="20"  valign="middle"
									class="word_orange"><div style="font: left;display:inline;">当前位置：首页 &gt;&gt;&gt;&nbsp;余额充值 &gt;&gt;&gt;&nbsp;</div><div style="float: right;;display:inline;" >${message }</div></td>
							</tr>
							<tr>
								<td valign="top">
									...
									<form action="<%=basePath%>AdminServlet" method="POST">
										<table  width="50%" style="margin: auto;margin-top: 40px" bgcolor="peru">
											<tr>
												...
												<input type="hidden" name="path" value="recharge"/>
													<span style="font-size: medium;"><b>余额充值</b></span>
												</td>
												
											</tr>
											<tr >
												<td style="text-align: right;" width="20%">用户名:</td>
												<td width="50%"> <input type="text" required="required"  name="readerName" style="margin-left: 10px" id=""readerName""/></td>
												<td width="30%"><span style="color: red;" >*输入充值用户名</span></td>
											</tr>
											<tr >
												<td style="text-align: right; " width="25%" >选择金额:</td>
												...
												<td width="40%"><span style="color: red;" >*选择充值金额</span></td>
											</tr>
											<tr height="50px">
												<td style="text-align: right;" width="20%"></td>
												<td width="50%"> 
												<div style="text-align: center;">
			                                        <input type="button" value="确认充值" style="background-color: burlywood" onclick="add()"/>
												</div>				
												</td>
